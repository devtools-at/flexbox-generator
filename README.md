...
<p align="center">
  <a href="https://devtools.at/tools/flexbox-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate CSS flexbox layouts</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/flexbox-generator">Try Online</a> •
...
**[Try CSS Flexbox Generator online at DevTools.at →](https://devtools.at/tools/flexbox-generator)**
...
Generate CSS flexbox layouts. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/flexbox-generator';
